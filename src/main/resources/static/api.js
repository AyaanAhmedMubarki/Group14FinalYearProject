...
async function createPrescription(appointmentId, medicineId, medicineName, dosage, frequency, duration, quantity, instructions, warnings) {
  const body = { appointment: { id: appointmentId }, medicineName, dosage, frequency, duration, quantity, instructions, warnings };
  if (medicineId) body.medicine = { id: medicineId };
  return apiPostJSON('/api/prescriptions/create', body);
}
