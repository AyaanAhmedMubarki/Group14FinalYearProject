    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // --- FIX: Allow Spring to serve your static frontend files ---
                        .requestMatchers("/*.html", "/*.js", "/*.css", "/images/**").permitAll()

                        // --- FIX: Prevent Spring from masking backend errors as 404s ---
                        ...
                        // Public: MediBot chatbot (accessible to all visitors)
